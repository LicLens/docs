...
{% hint style="info" %}
Some permission use and analysis capabilities depend on tenant licensing. Controls requiring unavailable licenses (e.g., PIM requires Entra ID P2) are automatically skipped.
{% endhint %}
